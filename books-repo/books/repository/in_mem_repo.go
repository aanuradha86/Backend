...
func NewInmemRepository() BookRepository {
	...
	1: {ID: nextID(), Title: "The C Book", Author: "Dennis Ritchie",ISBN:"1",Price:"11",Description:"tem"},
		2: {ID: nextID(), Title: "C++", Author: "Bjarne Stroustrop",ISBN:"2",Price:"14",Description:"tem"},
		3: {ID: nextID(), Title: "C+++", Author: "Bjarne Stroustrop",ISBN:"3",Price:"13",Description:"tem"},
	}}
